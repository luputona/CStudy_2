// 15-06-11 winapi.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		break;
	case WM_CREATE:
		//2.타이머번호 , 3. 1/1000  4.타이머 주기마다 실행할 함수
		//null을 넣으면 WM_TIMER실행
		SetTimer(hWnd,NULL,0,NULL);
		break;
	case WM_TIMER:
		//2.갱신 되어야할 렉트 크기 3.무효화할지 안할지 
		InvalidateRect(hWnd,NULL,TRUE); //페인트쪽을 불러준다
		break;
	case WM_KEYDOWN:
		switch(wParam)
		{
